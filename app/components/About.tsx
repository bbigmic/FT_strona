    ...
    <section id="about" className="py-16 bg-black relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-20">
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-accent to-blue-600 rounded-2xl opacity-20 blur-xl group-hover:opacity-40 transition-opacity duration-500"></div>
            <motion.div 
              layout
              className="rounded-xl overflow-hidden border border-white/10 bg-[#0a0a0a] shadow-2xl relative h-full flex flex-col"
            >
              <div className="bg-[#1c1c1e] px-4 py-3 flex items-center gap-2 border-b border-white/5 relative z-10 shrink-0">
                <div className="flex gap-2">
                  <div className="w-3 h-3 rounded-full bg-[#ff5f56] hover:bg-[#ff5f56]/80 transition-colors shadow-lg shadow-red-500/20" />
                  <div className="w-3 h-3 rounded-full bg-[#ffbd2e] hover:bg-[#ffbd2e]/80 transition-colors shadow-lg shadow-yellow-500/20" />
                  <div className="w-3 h-3 rounded-full bg-[#27c93f] hover:bg-[#27c93f]/80 transition-colors shadow-lg shadow-green-500/20" />
                </div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 rounded-lg border border-white/10 text-gray-400 hover:text-accent hover:border-accent/40 transition-colors"
                  ...
                  {copied && <span className="text-[10px] font-mono text-accent">COPIED</span>}
                </div>
              </div>
              <div className={`p-6 text-left font-mono text-sm md:text-base ${isFullscreen ? "flex-1 overflow-auto" : "h-96 overflow-hidden"} flex flex-col`}>
