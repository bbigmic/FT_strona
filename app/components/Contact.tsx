...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-16 bg-black relative border-t border-white/5">
          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-6 group">
                <div className="p-4 bg-[#111] rounded-2xl border border-white/10 group-hover:border-accent/50 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-gray-400 font-mono">contact@feliztradeltd.com</p>
                </div>
              </div>

              <div className="flex items-start space-x-6 group">
                <div className="p-4 bg-[#111] rounded-2xl border border-white/10 group-hover:border-accent/50 transition-colors">
                  <Phone className="w-6 h-6 text-white group-hover:text-accent transition-colors" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Voice Channel</h3>
                  <p className="text-gray-400 font-mono">+48 123 456 789</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Base Location</h3>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                ...
                <button
                  ...
                  className="w-full bg-white text-black font-bold py-5 rounded-xl hover:bg-gray-200 transition-all flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed group"
                >
                  {isSubmitting ? (
                    <span className="font-mono">SENDING_DATA...</span>
                  ) : (
                    <>
              ...
              <AnimatePresence>
                {isSuccess && (
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold text-white mb-2 tracking-tight">System Notification</h3>
                    ...
                    <button
                      ...
                      className="px-8 py-3 bg-white/10 hover:bg-white/20 border border-white/10 rounded-full text-white transition-all font-mono text-sm uppercase tracking-widest flex items-center gap-2"
                    >
                      <X className="w-4 h-4" />
                      Zamknij
                    </button>
