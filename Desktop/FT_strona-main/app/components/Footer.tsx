          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <Link 
                  href="#" 
                  className="flex items-center justify-center w-full px-4 py-2 text-xs sm:text-sm text-gray-400 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-white/20 hover:text-white transition-all duration-300"
                >
                  {t.footer.company_links.about_us}
                </Link>
              </li>
              <li>
                <Link 
                  ...
                  className="flex items-center justify-center w-full px-4 py-2 text-xs sm:text-sm text-gray-400 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-white/20 hover:text-white transition-all duration-300"
                >
                  {t.footer.company_links.careers}
                </Link>
              </li>
              <li>
                <Link 
              ...
              <li>
                <Link 
                  ...
                  className="flex items-center justify-center w-full px-4 py-2 text-xs sm:text-sm text-gray-400 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-white/20 hover:text-white transition-all duration-300"
                >
                  {t.footer.company_links.contact}
                </Link>
              </li>
            </ul>
          </div>
